...
cst_leave = 1.5
"""multiplication of additional tasks hours in weekend days by this constant"""
...
class TimesheetExtension(models.Model):
    ...
    work_type = fields.Selection([
        ...
        ('requested_project_manager', 'Effort requested by project manager'),
        # ('personal_effort', 'Personal effort'),
    ], default='working_hours', string='Work Type')
